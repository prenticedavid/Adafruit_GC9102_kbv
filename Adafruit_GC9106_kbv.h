...
#ifndef _ADAFRUIT_GC9106_KBV_H_
#define _ADAFRUIT_GC9106_KBV_H_
...
class Adafruit_GC9106_kbv : public Adafruit_SPITFT {
public:
  Adafruit_GC9106_kbv(int8_t _CS, int8_t _DC, int8_t _MOSI, int8_t _SCLK,
                   int8_t _RST = -1, int8_t _MISO = -1);
  Adafruit_GC9106_kbv(int8_t _CS, int8_t _DC, int8_t _RST = -1);
#if !defined(ESP8266)
  Adafruit_GC9106_kbv(SPIClass *spiClass, int8_t dc, int8_t cs = -1,
                   int8_t rst = -1);
#endif // end !ESP8266
  Adafruit_GC9106_kbv(tftBusWidth busWidth, int8_t d0, int8_t wr, int8_t dc,
