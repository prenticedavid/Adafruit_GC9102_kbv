...
*/
/**************************************************************************/
Adafruit_GC9106_kbv::Adafruit_GC9106_kbv(int8_t cs, int8_t dc, int8_t mosi,
...
*/
/**************************************************************************/
Adafruit_GC9106_kbv::Adafruit_GC9106_kbv(int8_t cs, int8_t dc, int8_t rst)
...
*/
/**************************************************************************/
Adafruit_GC9106_kbv::Adafruit_GC9106_kbv(SPIClass *spiClass, int8_t dc, int8_t cs,
                                   int8_t rst)
...
*/
/**************************************************************************/
Adafruit_GC9106_kbv::Adafruit_GC9106_kbv(tftBusWidth busWidth, int8_t d0, int8_t wr,
...
*/
/**************************************************************************/
void Adafruit_GC9106_kbv::begin(uint32_t freq) {
...
*/
/**************************************************************************/
void Adafruit_GC9106_kbv::setRotation(uint8_t m) {
...
*/
/**************************************************************************/
void Adafruit_GC9106_kbv::invertDisplay(bool invert) {
...
*/
/**************************************************************************/
void Adafruit_GC9106_kbv::scrollTo(uint16_t y) {
  uint8_t data[2];
  data[0] = y >> 8;
  data[1] = y & 0xff;
 ...
 */
/**************************************************************************/
void Adafruit_GC9106_kbv::setScrollMargins(uint16_t top, uint16_t bottom) {
...
*/
/**************************************************************************/
void Adafruit_GC9106_kbv::setAddrWindow(uint16_t x1, uint16_t y1, uint16_t w,
                                     uint16_t h) {
  x1 += _xstart;
  y1 += _ystart;
