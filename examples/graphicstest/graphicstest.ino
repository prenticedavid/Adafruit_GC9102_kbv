...
Adafruit_GC9102_kbv tft(TFT_CS, TFT_DC, TFT_RST);
//#include "Adafruit_GC9106_kbv.h"
//Adafruit_GC9106_kbv tft(TFT_CS, TFT_DC, TFT_RST);

// SoftSPI - note that on some processors this might be *faster* than hardware SPI!
//Adafruit_GC9102_kbv tft(TFT_CS, TFT_DC, MOSI, SCK, TFT_RST, MISO);



void setup() {
  Serial.begin(9600);
  Serial.println("GC9102_kbv Test!"); 

  tft.begin();
/*
  // read diagnostics (optional but can help debug problems)
  uint8_t x = tft.readcommand8(GC9102_RDMODE);
  Serial.print("Display Power Mode: 0x"); Serial.println(x, HEX);
  x = tft.readcommand8(GC9102_RDMADCTL);
  Serial.print("MADCTL Mode: 0x"); Serial.println(x, HEX);
  x = tft.readcommand8(GC9102_RDPIXFMT);
  Serial.print("Pixel Format: 0x"); Serial.println(x, HEX);
  x = tft.readcommand8(GC9102_RDIMGFMT);
  Serial.print("Image Format: 0x"); Serial.println(x, HEX);
  x = tft.readcommand8(GC9102_RDSELFDIAG);
...
*/  
  ...
  Serial.println(testCircles(10, TFT_RED));
  delay(500);
